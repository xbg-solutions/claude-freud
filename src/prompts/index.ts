...
export function buildDreamPrompt(project: Project): string {
  const memoryContent = [
...
export function buildComparePrompt(projectA: Project, projectB: Project, analysisA: string, analysisB: string): string {
  const instructionsA = [
...
export function buildHomogenizePrompt(projects: Project[], globalInstructions: string | null): string {
