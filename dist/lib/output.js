...
function parseAnalysisResponse(raw, projectId, projectName) {
...
export function formatSummaryTerminal(raw, projectId, projectName) {
...
export function formatSummaryMd(raw, projectId, projectName) {
    const analysis = parseAnalysisResponse(raw, projectId, projectName);
    const lines = [];
...
export function formatCompareTerminal(raw, nameA, nameB) {
    const lines = [];
    lines.push('');
...
export function formatCompareMd(raw, nameA, nameB) {
    return `## Comparative Analysis: ${nameA} × ${nameB}\n\n${raw}\n`;
}
export function formatHomogenizeTerminal(proposal) {
    const lines = [];
    lines.push('');
...
export function formatHomogenizeMd(proposal) {
    const lines = [];
